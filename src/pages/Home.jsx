            ...
            <div className="container home-container">
                ...
                <div className="row">
                    <div className="col-8 offset-2 parrafito text-grey">
                        <p>Aprende desarrollo web con HTML5, CSS y JavaScript. Backend con Python. React, Go, Laravel. Desarrollo móvil con Android, Flutter y mucho más. <b>Desde tu casa.</b></p>
